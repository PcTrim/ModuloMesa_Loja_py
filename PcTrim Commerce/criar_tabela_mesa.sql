-- Script para criar a tabela 'mesa' com a mesma estrutura da tabela 'comanda'
...
SET @ddl := IF(@col_cliente_exists = 0,
    'ALTER TABLE mesa ADD COLUMN cliente VARCHAR(255) DEFAULT NULL',
    'SELECT 1'
);
...
-- Conta registros
SELECT COUNT(*) as total_registros FROM mesa;
